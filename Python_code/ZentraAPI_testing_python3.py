...
start_time_loc = dt.datetime(2021,1,1,0,0)
...
for site_name in site_list['Site Name']:
    print ()
    print (site_name)
    try:
...
#    ip,key_name,token= "zentracloud.com",'AlexMessina','1a45a3456373971b5d1120ab9a9953e731f13402'
    ip,key_name,token= "zentracloud.com",'AlexMessina','c0468131feb3adfdcc98e65a41c6924f8aa223d8'
    ## Format start time
    mytz = timezone('US/Pacific')
